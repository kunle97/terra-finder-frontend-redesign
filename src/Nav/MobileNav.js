  ...
  return (
    <nav className="mobile-nav" >
      <div className="mobile-nav-top-bar">
        <a href="/" style={{float: 'left'}} ><img src={terra_logo} width="50" /></a>
        {/* Contains hamburger button and logo */}

        <div class={`hamburger mobile-menu-toggle-btn ${showMenu && "is-active"}`} id="hamburger-1"  onClick={toggleMenu}>
      ...
      {showMenu && (
        <div className="mobile-nav-menu-list-contianer">
          <ul className="mobile-nav-menu-list">
            ...
            <li>
              <form className="mobile-nav-form" onSubmit={submitHandler}>
                <input
                  ref={searchInput}
                  type="search"
